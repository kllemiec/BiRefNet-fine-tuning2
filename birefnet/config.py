...
class Config():
    def __init__(self) -> None:
        ...
        self.sys_home_dir = "/root/GoPhoto"
        self.data_root_dir = "/root/GoPhoto/data"

        # TASK settings
        self.task = ['custom_task'][0]
        self.testsets = {
            # Benchmarks
      ...
      #      'Matting': datasets_all,
        ...
        self.use_gradient_checkpointing = True  # Add gradient checkpointing for memory efficiency
