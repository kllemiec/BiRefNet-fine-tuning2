...
# if use_accelerate and accelerator.mixed_precision != 'no':
...
class Trainer:
    ...
    def train_epoch(self, epoch):
        ...
        for batch_idx, batch in enumerate(self.train_loader):
            # with nullcontext if not use_accelerate or accelerator.gradient_accumulation_steps <= 1 else accelerator.accumulate(self.model):
